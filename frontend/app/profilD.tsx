...
import axios from 'axios';import { Alert } from 'react-native';
...
export default function ProfilD() {
  ...
  const fetchUserData = async () => {
    ...
    try {
      ...
      console.log(userId,'hay te5dem ');
      const response = await axios.get(`http://192.168.1.7:5000/user/user/${userId}`);
      ...
      <View style={styles.cont1}>
              <View>
                <Image source={require('../assets/images/logo.png')} style={styles.logo} />
                      ...
                      <TouchableOpacity onPress={handleSignOut} style={styles.dropdownButton1}>
  <MaterialIcons name="logout" size={35} color="#4169E1" />
</TouchableOpacity>
      ...
      {loading ? (
        ...
        <View style={styles.profileContainer}>
          ...
          <View style={styles.infoSection}>
            ...
            <View style={styles.infoRow}>
              <MaterialIcons name="car-repair" size={24} color="#4169E1" />
              <Text style={styles.infoText}>{mark} - {serie}</Text>
            </View>
